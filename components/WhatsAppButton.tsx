...
const IG_URL    = 'https://www.instagram.com/newera_uae?igsh=cjlwdnF3bTk5MDQ2'
...
function SocialBtn({
  ...
  return (
    ...
    >
      {/* Label pill */}
      <span className={`
        font-body text-xs text-cream/80 bg-stone border border-white/10
...
export default function WhatsAppButton() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-end">
      ...
      {/* Instagram */}
      <SocialBtn href={IG_URL} label="Instagram">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
          <rect x="2" y="2" width="20" height="20" rx="6" stroke="#C9A84C" strokeWidth="1.6"/>
          <circle cx="12" cy="12" r="4.5" stroke="#C9A84C" strokeWidth="1.6"/>
          <circle cx="17.5" cy="6.5" r="1" fill="#C9A84C"/>
        </svg>
      </SocialBtn>

      {/* WhatsApp */}
      <SocialBtn href={`https://wa.me/${WA_NUMBER}`} label="WhatsApp">
